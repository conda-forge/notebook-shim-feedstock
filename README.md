...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/notebook-shim-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15575&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/notebook-shim-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `notebook-shim` can be installed with:

```
conda install notebook-shim
```

It is possible to list all of the versions of `notebook-shim` available on your platform with:
